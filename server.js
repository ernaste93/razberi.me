...
function buildSystemPrompt({ lessonTitle, lessonSubject, lessonGrade, lessonText }) {
  ...
  const gradeNote = grade <= 7
    ? `Ученикът е в 7 клас (12–13 години). Обяснявай много просто и конкретно — кратки изречения, прости думи, аналогии от ежедневието на дете. Избягвай сложни литературни термини без обяснение. Бъди насърчаващ и търпелив.`
    : grade <= 9
    ? `Ученикът е в ${grade} клас. Обяснявай ясно, с умерена сложност — може да използваш основни термини, но ги обяснявай накратко.`
    : `Ученикът е в ${grade} клас. Може да използваш пълна литературна/научна терминология на ниво матура.`;
...
- Използвай правилна историческа, литературна и научна терминология. Например: "чета" (не "банда"), "хайдути" (не "разбойници"), "въстание" (не "бунт"), "лирически герой" (не "главен герой в стихотворение"). Обясненията трябва да са на достъпен език, но с коректни термини.
